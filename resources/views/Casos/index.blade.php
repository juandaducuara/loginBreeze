        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('seguimiento.edit', $caso->id) }}" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hammer" viewBox="0 0 16 16">
